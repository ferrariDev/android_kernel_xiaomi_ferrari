...
one(){
	...
	echo "${cyan}"
	while read -p " Desired toolchain: UBERTC 4.9(1) | SABERMOD4.9(2) | UBERTC7.0(3)?" echoice
	do
	case "$echoice" in
	1 )
	...
	2 )
		...
		;;
	3 )
		export CROSS_COMPILE="~/Development/SenseiKernel/toolchains/uber7/bin/aarch64-linux-android-"
		TC="UBER7"
		echo "${blue}"
